 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      var found = 0;
      // debugger;
      for (var spot = 0; spot < this.get(rowIndex).length; spot++) {
        if (this.get(rowIndex)[spot] === 1) {
          found++;
        }
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      ...
      //traverse diagonal line
      for (var spot = 0; spot < this.get('n'); spot ++) {
        //check to see if we're in bounds
        if (column >= 0 && this.get(row)[column] === 1) {
          found++;
        }
        if (found > 1) {
          return true;
    ...
    hasAnyMajorDiagonalConflicts: function() {
      for (var col = -(this.attributes.n - 1); col < this.attributes.n; col++) {
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      //traverse diagonal line
      for (var spot = 0; spot < this.attributes.n; spot ++) {
        //check to see if we're in bounds
        if (column < this.attributes.n && this.get(row)[column] === 1) {
          found++;
        }
        if (found > 1) {
          return true;
    ...
    hasAnyMinorDiagonalConflicts: function() {
      for (var col = 0; col < 2 * this.attributes.n; col++) {
